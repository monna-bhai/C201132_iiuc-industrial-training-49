...
def create_db_connection():
    ...
    try:
        ...
        print("MySQL Database connection successful by - Helal Faruk Monna, C201132!")
        return connection
    except Error as e:
...
if __name__ == "__main__":
    ...
    if conn is not None:
        ...
        insert_reporter(conn, "Ayub", "ayub@ugrad.iiuc.ac.bd")
        ...
        conn.commit()
        conn.close()
        print("Database created successfully by -Helal Faruk Monna, C201132!")
