...
def post_example():
    ...
    url = 'https://jsonplaceholder.typicode.com/posts'
    data = {
        'title': 'Checking POST request with JSON data by- Helal Faruk MONNA, C201132',
        'body': 'This is a POST request with JSON data by- Helal Faruk MONNA, C201132',
        'userId': 1
    }
...
def MONNA_modified_post_example():
    """
    ...
    url = 'https://jsonplaceholder.typicode.com/posts'
    data = { 
        'title': 'Testing POST request with modified headers by- Helal Faruk MONNA, C201132',
        'body': 'This is a POST request with modified headers by- Helal Faruk MONNA, C201132',
        'userId': 1
    }
    
    custom_headers = {
        'Need-Modified-Header': 'Helal Faruk MONNA, C201132',
    }
...
# 1. Modify the GET Example: Change the get_example function to fetch a list of posts instead of just one. Analyze the JSON structure and print out the titles of all posts.
    #Helal Faruk MONNA, C201132's solution: Done, Please check it above.
